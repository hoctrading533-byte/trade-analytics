...
async function run() {
  ...
  console.log("DailyStats generated length:", dailyStats.length);
  console.log("First element date:", dailyStats[0]?.date);
  console.log("Second element date:", dailyStats[1]?.date);
}
run();
